          ...
          <MDBCard className="h-100 smallCard">
            ...
            <MDBCardBody>
              ...
              <MDBCardText>
                ...
                searching for a place the background image changes based on the
                location searched with the help of the unsplash API.
              </MDBCardText>
            </MDBCardBody>
            <MDBCardFooter>
          ...
          <MDBCard className="h-100 smallCard">
            ...
            <MDBCardBody>
              ...
              <MDBCardText>
                ...
                charities. All data is collected from the Every.orf Charity API.
                With the use of the Stripe API the user is able to enter their
                credit card details and proceed with the payment. There is an
                option to subscribe to the newsletter with a valid gmail address
                and get a notification verifying the subscription process.
              </MDBCardText>
            </MDBCardBody>
            <MDBCardFooter>
              <small className="text-muted">Technologies used:</small>
